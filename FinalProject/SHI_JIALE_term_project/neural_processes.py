#Neural Processes: Garnelo, M., Schwarz, J., Rosenbaum, D., Viola, F., Rezende, D.J., Eslami, S.M. and Teh, Y.W. Neural processes. 
#ICML Workshop on Theoretical Foundations and Applications of Deep Generative Models 2018.

##https://github.com/shijiale0609/Gaussian_Process_NN/tree/master/neural-processes

## change the maximum context number
...
MAX_CONTEXT_POINTS = 20 #@param {type:"number"} # I modify the max_context_points. I find that the default number 50 
#that the author offer is too large.
PLOT_AFTER = 20000 #@param {type:"number"}
